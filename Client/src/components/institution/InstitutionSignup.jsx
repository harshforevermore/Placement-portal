...
const InstitutionSignup = ({ onClose, onSwitchToLogin }) => {
  ...
  const validateStep = (step) => {
    ...
    if (step === 2) {
      if (!formData.emailDomain) {
        ...
        newErrors.emailDomain = "Please Enter a valid email domain";
      }
      if (!formData.email) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axiosClient.post("/api/auth/institution/register", formData);
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="space-y-2">
          ...
          {errors.emailDomain && (
            <p className="text-red-400 text-sm">{errors.emailDomain}</p>
          )}
        </div>
      </div>
      ...
      <div className="space-y-2">
        ...
        <div className="relative">
          ...
          <input
            ...
            placeholder="123, diagon alley"
          />
        </div>
        {errors.street && (
          <p className="text-red-400 text-sm">{errors.street}</p>
        )}
      </div>
        ...
        <div className="flex justify-center items-center gap-3 mb-4">
          ...
          <div>
            ...
            <p className="text-slate-400 text-sm">
              Join our placement management platform
            </p>
          </div>
        </div>
      </div>
